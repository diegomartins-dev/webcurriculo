                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-6 text--white text--shadow">
                            ...
                            <ul className="--no-list-style --no-padding-left">
                                <li><a className="text--white" target="_blank" rel="noopener noreferrer" href="https://github.com/diegohyenna">GitHub</a></li>
                                <li><a className="text--white" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/diego-martins-362136123/">Linkedin</a></li>
                                <li><a className="text--white" target="_blank" rel="noopener noreferrer" href="http://dgsite.pessoal.ws">Portifólio</a></li>
                            </ul>                            
                        </div>
